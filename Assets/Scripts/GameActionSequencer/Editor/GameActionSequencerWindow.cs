...
public class GameActionSequencerWindow : EditorWindow
{
    Rect window1;
    Rect window2;

    [MenuItem("Window/GameAction")]
    public static void ShowWindow()
    {
        GameActionSequencerWindow editor = GetWindow<GameActionSequencerWindow>("GameAction");
        editor.Init();
    }
    public void Init()
    {
